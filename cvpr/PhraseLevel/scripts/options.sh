...
HMM_LOCATION=$HMM_TOPOLOGY_DIR/12state-pca20	#text hmm topology file
...
GRAMMARFILE=${PRJ}/grammar/grammar_letter_isolated_ai			# the grammar definition
GRAMMARFILE_WORD=${PRJ}/grammar/grammar_word_isolated_ai

DICTFILE=${PRJ}/dict/dict_letter2letter_ai # Use this for monoletter
#DICTFILE=${PRJ}/dict/dict_tri2letter #Use this for triletters 
DICTFILE_WORD=${PRJ}/dict/dict_letter2word_ai
#DICTFILE_WORD=${PRJ}/dict/dict_tri2word
DICTFILE_ALIGN=${PRJ}/dict/dict_tri2tri # Dictionary used during forced alignment

TOKENS_ORIGINAL=${PRJ}/commands/commands_letter_isolated_ai # used for building model
TOKENS=${PRJ}/commands/commands_letter_isolated_ai  #tri_internal letter_isolated letter 
#TOKENS=${PRJ}/commands/commands_tri_internal
TOKENS_WORD=${PRJ}/commands/commands_word_isolated_ai
