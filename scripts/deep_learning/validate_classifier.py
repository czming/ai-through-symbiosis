...
#     ])
#     learning_rate = 0.075
#     model_path = '../model_training_checkpoints/model_resnet34_classifier_epoch_55.pt'
#     batch_size = 512
...
#         lr = learning_rate
#         model_path = f'../model_training_checkpoints/model_resnet34_classifier_epoch_30_lr_{lr}.pt'
#         batch_size = 512
#         dataset = EgoObjectClassificationDataset('../data/labeled_objects_val.csv', test=True, transform=image_transforms)
#         train_dataloader = DataLoader(dataset, batch_size=batch_size)
#         model_architecture = 'resnet34'
#         model = get_model()
#         model.load_state_dict(torch.load(model_path)['model_state_dict'])
...
#         # plt.show()
#
#         plt.savefig(f'results_test_classifier_{lr}.png')
#         val_accuracies.append((lr, total_acc))
